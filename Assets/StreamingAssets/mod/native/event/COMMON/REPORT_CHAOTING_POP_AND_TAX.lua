desc = function ()
    return { 'REPORT_CHAOTING_POP_AND_TAX', gm_data().chaoting.year_expect_tax }
end
...
options = 
{
    OPTION_1 = 
    {
        ...
        desc = function (self)
            return { 'REPORT_CHAOTING_POP_AND_TAX_OPTION1', gm_data():tax_report(self.report_pop_num()) }
        end,
    ...
    OPTION_2 = 
    {
        ...
        desc = function (self)
            return { 'REPORT_CHAOTING_POP_AND_TAX_OPTION2', gm_data():tax_report(self.report_pop_num()) }
        end,
    ...
    OPTION_3 = 
    {
        ...
        desc = function (self)
            return { 'REPORT_CHAOTING_POP_AND_TAX_OPTION3', gm_data():tax_report(self.report_pop_num()) }
        end,
    ...
    OPTION_4 = 
    {
        ...
        desc = function (self)
            return { 'REPORT_CHAOTING_POP_AND_TAX_OPTION4', gm_data():tax_report(self.report_pop_num()) }
        end,
