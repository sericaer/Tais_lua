EVENT_DEF.GLOBAL.EVENT_CHAOTING_CALC_TAISHOU_SCORE_START = 
{
    trigger = function()
        ...
        OPTION_1=
        {
            ...
            next_event = function ()
                ...
                if tax > 0 and pop > 0 then
                    return 'EVENT_CHAOTING_CALC_TAISHOU_SCORE_GOOD'
                end
                if tax < 0 and pop < 0 then
                    return 'EVENT_CHAOTING_CALC_TAISHOU_SCORE_BAD'
                end
                return 'EVENT_CHAOTING_CALC_TAISHOU_SCORE_NORMAL'
            end
        }
    }
}